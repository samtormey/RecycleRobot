function [ handles ] = drawScara( joint_angles, robot )
...
%   
%    The function RRFK() must be completed in order to run this function.
%
%    Make use of your code from Lab 3 to fill out the missing code in the
%    section "Create frames and links"
%
      

% Create structure of RR robot forward kinematics transforms
[~,robot_T] = ScaraFK(joint_angles,robot);
...
hg = hggroup('Parent',ax);
set(h,'Parent',hg);
L_1 = line([robot.l_1,0,0],[0,0,0],[0,0,0],...
...
hg = hggroup('Parent',ax);
set(h,'Parent',hg);
L_2 = line([robot.l_2,0,0],[0,0,0],[0,0,0],...
...
hg = hggroup('Parent',ax);
set(h,'Parent',hg);
L_3 = line([0,0,0],[0,0,0],[-robot.l_3,0,0],...
