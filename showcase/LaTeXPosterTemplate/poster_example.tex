...
\begin{itemize}
	...
	\item This constraint on kinetic energy gives us $f$ in the optimization problem below.
\end{itemize}
\end{column}
\begin{column}{16cm}{}
\centering\includegraphics[height=17cm, width = 17cm]{figures/double-pendulum.png}\\
\end{column}
...
\begin{align*}
\min  & \: \:T \\
	\mbox{s.t. } & \frac{x_{i+1}-x_j}{\Delta\tau} = Tf(x_i,u_i) \\
& x_1 = x_0 \\
& x_n = x_T \\
& 1 \leq i \leq n \\
